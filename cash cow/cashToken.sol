...
contract CASH is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   CASHDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("CASH", "$CASH") {
		...
		contractTokenBalanceAmount = 2500 * 10**18;
        
        swapTokensAtAmount = 2500 * (10**18);
        _maxWallet = 20000 * (10**18);
        _maxBuy = 5000 * (10**18);
        _maxSell = 5000 * (10**18);
		...
		marketingWallet = payable(0x14B97888B5Ee06413856dc05B1b0D8438e71994d);
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "CASH: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "CASH: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "CASH: Account is already the value of 'blacklisted'");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "CASH: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "CASH: The marketing wallet is already this address");
...
contract CASHDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("CASH_Dividend_Tracker", "CASH_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "CASH_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
